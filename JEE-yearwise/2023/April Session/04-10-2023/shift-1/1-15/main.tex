...
%20 
    \item Let two vertices of a triangle ABC be \brak{2,4,6} and \brak{0,-2,-5}, and its centroid be \brak{2,1,-1}. If the image of the third vertex in the plane $x+2y+4z=11$ is \brak{a,b,c}, then $ab+bc+ca$ is equal to:
     \hfill{[Apr 2023]}
		\begin{multicols}{1}
			\begin{enumerate}
